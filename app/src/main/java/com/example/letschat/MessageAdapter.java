...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    @NonNull
    @Override
    public MessageViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, final int i) {
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int i) {
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChild("image"))
                {
                    ...
                    Picasso.get().load(receiverImage).placeholder(R.drawable.avat).into(messageViewHolder.receiverProfileImage);
                }
        ...
        if(fromMessageType.equals("text")){
            ...
            if(fromUserID.equals(messageSenderID))
            {
                messageViewHolder.messageSenderPicture.setVisibility(View.VISIBLE);
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/letschat-0000.appspot.com/o/Image%20Files%2Fbaseline_insert_drive_file_black_24dp.png?alt=media&token=cbc90cb7-382a-4afd-bc55-e1852ea55000")
    ...
    private void deleteSentMessages(final int positon, final MessageViewHolder holder){
        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
        rootRef.child("Messages").child(userMessagesList.get(positon).getFrom()).child(userMessagesList.get(positon).getTo())
    ...
    private void deleteReceiveMessages(final int positon, final MessageViewHolder holder){
        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
        rootRef.child("Messages").child(userMessagesList.get(positon).getTo()).child(userMessagesList.get(positon).getFrom())
                .child(userMessagesList.get(positon).getMessageID())
                .removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
    ...
    private void deleteMessagesForEveryOne(final int positon, final MessageViewHolder holder){
