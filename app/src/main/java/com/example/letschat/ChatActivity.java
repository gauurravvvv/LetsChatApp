...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(messageReceiverImage).placeholder(R.drawable.avat).into(userImage);
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            startActivityForResult(intent.createChooser(intent, "Select an Image"), 0000); //request code can be any number
                        }
                        if (i == 1) {
                            checker = "pdf";
                            Intent intent = new Intent();
                            ...
                            startActivityForResult(intent.createChooser(intent, "Select Pdf File"), 0000); //request code can be any number
                        ...
                        if (i == 2) {
                            ...
                            startActivityForResult(intent.createChooser(intent, "Select Word Image"), 0000); //request code can be any number
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==0000 && resultCode== RESULT_OK && data!=null && data.getData()!=null){
